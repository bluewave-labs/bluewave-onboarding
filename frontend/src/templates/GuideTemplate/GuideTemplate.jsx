...
const GuideTemplate = ({ title = '', handleButtonClick = () => null, activeButton = 0, leftContent = () => null, rightContent = () => null, leftAppearance = () => null, onSave= () => null, handleCloseIconClick = () => {} }) => {
        ...
        <div className={styles.container}>
            <div className={styles.popup}>
                <div className={styles.header}>
                    ...
                    <CloseOutlinedIcon style={{ color: '#98A2B3', fontSize: '20px', cursor: "pointer" }} onClick={handleCloseIconClick} />
                </div>
