...
const CreatePopupPage = () => {
    ...
    const [buttonAction, setButtonAction] = useState(constants.ACTIONS_TYPES.OPEN_URL_IN_NEW_TAB);
        ...
        if (location.state?.isEdit) {
            const fetchPopupData = async () => {
                try {
                    ...
                    setButtonAction(popupData.closeButtonAction || constants.ACTIONS_TYPES.NO_ACTION);
    ...
    const onSave = async () => {
        const popupData = {
            ...
            closeButtonAction: buttonAction,
            header: header,
            content: content
        };
        try {
