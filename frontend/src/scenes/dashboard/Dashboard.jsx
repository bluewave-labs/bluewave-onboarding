...
const Dashboard = ({ username }) => {
    ...
    const buttons = [
        { placeholder: "Create a welcome tour", onClick: () => navigate('/welcome-tour-route') },
        { placeholder: "Add a hint to your app", onClick:() => navigate('/hint-route') },
        { placeholder: "Create a new banner", onClick:() => navigate('/new-banner-route') }
    ];
    return (
        <>
